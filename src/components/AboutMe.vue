      ...
      <v-flex d-flex xs12 sm8 md8>
        <v-layout row wrap>
          <v-flex id="Section1">
            ...
            <ul>
              <li>
                I love to cook. I'm currently perfecting my searing techniques after
                immersing myself into the world of using sous vide for proteins.
              </li>
              <li>
                Mindfulness techniques are an important (and often underutilized)
                set of tools in my arsenal for maintaining a semblance of sanity in
                the modern world.
              </li>
              <li>
                If I had it my way, I would only wear toe shoes. I honestly can't stand
                traditional footwear, so I'm almost always wearing some form of minimalist
                shoe.
              </li>
              <li>
                I love coffee, tea, yerba mate, chocolate, etc. I have a lot of respect
              ...
              <li>
                I love hacking. My next career goal is to become a penetration tester for
